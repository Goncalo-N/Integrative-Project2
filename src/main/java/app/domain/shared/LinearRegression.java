...
public class LinearRegression {
     ...
     *
     * @param  x the values of the predictor variable - numero de testes diarios ou mean age
     * @param  y the corresponding values of the response variable - numero de testes positivos
    ...
    public LinearRegression(double[] x, double[] y) {
        ...
        //  System.out.println("Total = " + yybar);
